...
public class CriticalNumbers : MonoBehaviour
{
    public static CriticalNumbers Create(Vector3 position, int damageAmount)
    {
        GameObject damageNumbersPrefab = Instantiate((Resources.Load("Prefabs/NumberPopups/CriticalHitNumbers") as GameObject), position, Quaternion.identity);
        CriticalNumbers damageNumbers = damageNumbersPrefab.GetComponent<CriticalNumbers>();
