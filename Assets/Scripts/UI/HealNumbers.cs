...
public class HealNumbers : MonoBehaviour
{
    public static HealNumbers Create(Vector3 position, int healAmount)
    {
         GameObject healNumbersPrefab = Instantiate((Resources.Load("Prefabs/NumberPopups/HealNumbers") as GameObject), position, Quaternion.identity);
        HealNumbers healNumbers = healNumbersPrefab.GetComponent<HealNumbers>();
        healNumbers.Setup(healAmount);
